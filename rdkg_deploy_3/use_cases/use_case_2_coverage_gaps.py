...
# ACTUAL COVERAGE NUMBERS (from live graph — use for Figure 4)
REAL_COVERAGE = {
    "total_diseases":           26106,
    "with_hpoa":                11926,   # 45.7%
    "with_orphanet_id":          2660,   # 10.2%
    "with_drug_annotation":      5288,   # 20.3%
    "with_gene_association":      206,   #  0.8%
    "phenotype_and_drug":        1596,   #  6.1%
}
